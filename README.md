...
Нарисуем графики, отражающие коллизии хеш функций с помощью GnuPlot и замерим скорость поиска в каждой из хеш таблиц. Коллизия замерена на основе данных из 7 томов, для лучшей оценки 1% самых больших значений обрезается до максимума из оставшихся 99%. Скорость измеряется на основе поиска 10 раз слов из файла "eng_words.txt" в хеш таблице с выбранной функцией.
